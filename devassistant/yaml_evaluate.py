...
def evaluate_expression(expression, names):
    ...
    def led(self, left):
        ...
        boolean = bool(left[0] and right[0])
    ...
    def led(self, left):
        ...
        boolean = bool(left[0] or right[0])
    ...
    @interpr.method("in")
    def led(self, left):
        boolean = left[1] in interpr.expression(10)[1]
        output = left[1]
    ...
    def nud(self):
        ...
        boolean = name in interpr.names
        output = interpr.names[name] if boolean else ""
    ...
    def nud(self):
        ...
        # Ugly hack to figure out what the  working directory is after
        # each command
        command += "; echo $?; pwd"
